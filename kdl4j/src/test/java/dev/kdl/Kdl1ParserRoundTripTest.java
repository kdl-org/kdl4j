...
public class Kdl1ParserRoundTripTest extends RoundTripTest {
	public Kdl1ParserRoundTripTest() {
		super(KdlVersion.V1);
	}
	...
	private static final Path INPUT_FOLDER = Paths.get("src/test/resources/test-cases/v1/input");
	private static final Path EXPECTED_FOLDER = Paths.get("src/test/resources/test-cases/v1/expected");
}
