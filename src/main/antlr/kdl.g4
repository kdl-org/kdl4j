...
parse : nodes? EOF;
nodes : node* ;
node : COMMENTED_CHUNK? multi_line_comment* identifier node_props_and_args* (node_children multi_line_comment*)? ;
node_props_and_args : (COMMENTED_CHUNK multi_line_comment*)? (value | prop) ;
prop : identifier '=' value ;
node_children : (COMMENTED_CHUNK (multi_line_comment)*)? '{' nodes '}' ;
